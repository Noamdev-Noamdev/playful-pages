...
const CAT_EMOJI: Record<string, string> = {
    Size: "📏", Speed: "💨", Distance: "📡", Quantity: "🔢", History: "📅",
};
...
export function RealityCheck() {
    ...
    const handleChoice = useCallback((val: boolean) => {
        ...
        return (
            <div className="flex flex-col gap-4">
                ...
                <div className="rounded-3xl border-2 border-foreground bg-card p-7 text-center">
                    <p className="text-5xl font-black text-foreground">{score} / {ROUNDS}</p>
                    <p className="text-muted-foreground text-sm mt-1">
                        {pct === 100 ? "🎯 Perfectly calibrated mind!" :
                            pct >= 80 ? "🔥 Your instincts are sharp!" :
                                pct >= 60 ? "👍 Solid! The world is surprising." :
                                    pct >= 40 ? "🤔 Reality is stranger than it seems." :
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 justify-between">
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${DIFF_STYLE[claim.difficulty]}`}>
                        {claim.difficulty}
                    </span>
                </div>
            </div>
            ...
            ${isCorrect
                    ...
                    <div className="flex gap-3">
                        <div className={`flex-1 rounded-2xl border-2 px-3 py-2.5 text-center
              ${choice === true
